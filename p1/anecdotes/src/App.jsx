...
const DisplayHoghestVote=({anecdotes,votes})=>{
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Button text="vote" handleClick={voteCount}/>
      <Button text="next anecdotes" handleClick={nextAntecdote}/>
      <DisplayHoghestVote anecdotes={anecdotes} votes={votes}/>
    </div>
  )
}
